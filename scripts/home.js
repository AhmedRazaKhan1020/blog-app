...
// import {profileImage} from "./register.js";
    ...
    try {
     ...
     docRef.forEach(element => {
        ...
        //  console.log(globalArray);
          ...
          <td><img src="${userData.userProfilePicUrl}" alt="img" class="image" style="width:100px;height:100px;"></td>
...
// const promg=document.querySelector("#promg");
// promg.innerHTML+=`
//  <img  alt="img" src="${profileImage}" >
// `